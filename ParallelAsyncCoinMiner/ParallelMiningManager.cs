...
namespace ParallelAsyncCoinMiner
{
    public class ParallelMiningManager
    {
        ...
        public void MineWithParallelForEachLoop()
        {
            ...
            ParallelLoopResult loopResult = Parallel.ForEach(numberArray, num => MineAsyncCoinsWithNthRoot(num));
            Console.WriteLine($"ParallelLoopResult.IsCompleted = {loopResult.IsCompleted}");
        }
        ...
        public void MineWithParallelInvoke()
        {
            ...
            Action mineWithRoots2 = () => MineAsyncCoinsWithNthRoot(5);
            Action mineWithPrimes = () => MineAsyncCoinsWithPrimes(2);
            Action mineWithPrimes2 = () => MineAsyncCoinsWithPrimes(5);
